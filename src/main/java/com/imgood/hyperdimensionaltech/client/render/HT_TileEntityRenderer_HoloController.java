...
public class HT_TileEntityRenderer_HoloController extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float timeSinceLastTick) {
        ...
        if (tile instanceof BaseMetaTileEntity) {
            ...
            if (ownerName.contains("BlockRender")) {
                ...
                if (((BaseMetaTileEntity) tile).getMetaTileID() == 10002 && progress != 0) {
                ...
                } else if (((BaseMetaTileEntity) tile).getMetaTileID() == 10002 && progress == 0) {
                    ...
                    /*if (!((BaseMetaTileEntity) tile).isInvalidTileEntity()) {
                        renderGlow(feildSizeX, feildSizeY, feildSizeZ,x,y,z,tile,"cubefrontline");

                    } else {
                        renderNoGlow(feildSizeX, feildSizeY, feildSizeZ,x,y,z,tile,"cubefrontline");
                    }*/
    ...
    private void drawCenteredString(TileEntity tile, String text, double x, double y, double z,int color) {
        ...
        // 平移到正确的位置
        //GL11.glTranslated(x + 0.5, y + 1.5, z + -1);
