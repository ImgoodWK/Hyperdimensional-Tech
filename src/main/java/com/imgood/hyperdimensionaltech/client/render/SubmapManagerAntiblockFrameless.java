...
public class SubmapManagerAntiblockFrameless extends SubmapManagerBase {
    ...
    public SubmapManagerAntiblockFrameless(String color) {
        this.color = color;
    }
    ...
    public void registerIcons(String modName, Block block, IIconRegister register) {
        submap = new TextureSubmap(
            register.registerIcon("chisel" + ":antiblockFrameless/" + color + "-antiBlockFrameless-ctm"),
            4,
            4);
        submapSmall = new TextureSubmap(
            register.registerIcon("chisel" + ":antiblockFrameless/" + color + "-antiBlockFrameless"),
            2,
            2);
    }
