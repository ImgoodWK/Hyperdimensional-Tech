package com.imgood.hyperdimensionaltech.geckolib.geckoitem;

/**
 * @program: Hyperdimensional-Tech
 * @description:
 * @author: Imgood
 * @create: 2024-08-15 10:05
 **/
...
public class HT_Sword extends Item implements IAnimatable {
    ...
    public void registerControllers(AnimationData data) {
        AnimationController<HT_Sword> controller = new AnimationController<HT_Sword>(this,
