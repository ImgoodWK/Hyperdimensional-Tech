...
public class HT_GuiButton extends GuiButton {
    ...
    public HT_GuiButton(int id, int x, int y, int width, int height, String text) {
    ...
    public HT_GuiButton setTextHoverColor(int textColor) {
        this.textColorHover = textColor;
        return this;
    }

    public HT_GuiButton setLeftDecoration(ResourceLocation leftDecoration) {
        this.leftDecoration = leftDecoration;
        return this;
    }

    public HT_GuiButton setRightDecoration(ResourceLocation rightDecoration) {
        this.rightDecoration = rightDecoration;
        return this;
    }

    public HT_GuiButton setDecorationWidth(int width) {
        this.decorationWidth = width;
        return this;
    }

    public HT_GuiButton setTexture(ResourceLocation texture) {
        this.texture = texture != null ? texture : DEFAULT_TEXTURE;
        return this;
    }

    public HT_GuiButton setHoverTexture(ResourceLocation hoverTexture) {
        this.hoverTexture = hoverTexture;
        this.useHoverEffect = (hoverTexture != null);
        return this;
    }

    public HT_GuiButton setTextColor(int color) {
        this.textColor = color;
        return this;
    }

    public HT_GuiButton setUseHoverEffect(boolean useHoverEffect) {
        this.useHoverEffect = useHoverEffect;
        return this;
    }

    public HT_GuiButton setUseRGBEffect(boolean useRGBEffect) {
        this.useRGBEffect = useRGBEffect;
        return this;
    }

    public HT_GuiButton setDisabledTextColor(int disabledTextColor) {
